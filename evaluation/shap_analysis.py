...
class SHAPAnalyzer:
    """Explain model outputs using SHAP feature attributions."""
    ...
    def analyze(self, X, y=None, feature_names=None):
        """Collect factor diagnostics and return the resulting report."""
    ...
    def plot_global_importance(self, save_path=None):
        """Plot aggregate feature attribution magnitudes."""
    ...
    def plot_summary(self, save_path=None):
        """Plot a summary of model feature attributions."""
